function displayTrace_adapted(neuron0,trialNum, group,idxTrail,colorClusters,conditionfolder)
...
saveas(gcf,[conditionfolder,'/','cluster C 1','.fig'],'fig');
saveas(gcf,[conditionfolder,'/','cluster C 1','.tif'],'tif');
saveas(gcf,[conditionfolder,'/','cluster C 1','.eps'],'epsc');
...
set(0, 'DefaultFigureRenderer', 'painters');
saveas(gcf,[conditionfolder,'/','cluster individual activity C','.fig'],'fig');
saveas(gcf,[conditionfolder,'/','cluster individual activity C','.tif'],'tif');
saveas(gcf,[conditionfolder,'/','cluster individual activity C','.eps'],'epsc');
...
set(0, 'DefaultFigureRenderer', 'painters');
saveas(gcf,[conditionfolder,'/','cluster average activity C','.fig'],'fig');
saveas(gcf,[conditionfolder,'/','cluster average activity C','.tif'],'tif');
saveas(gcf,[conditionfolder,'/','cluster average activity C','.eps'],'epsc');
