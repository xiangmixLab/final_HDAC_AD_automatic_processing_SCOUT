            function ampcompexcel=amplitude_analysis_single_spike(amplitude,amplitude_normalized,binsize,countTime,objects,colorscale4,colorscale8,objname,conditionfolder,nameparts,nameset,num2readt,ampcompexcel,i)
            ...
            saveas(gcf,[conditionfolder{i},'/','neuron comparingAmplitude_single_spike_binsize',num2str(binsize),'.fig'],'fig');
            saveas(gcf,[conditionfolder{i},'/','neuron comparingAmplitude_single_spike_binsize',num2str(binsize),'.tif'],'tif');
            saveas(gcf,[conditionfolder{i},'/','neuron comparingAmplitude_single_spike_binsize',num2str(binsize),'.eps'],'epsc');
            ...
            saveas(gcf,[conditionfolder{i},'/','neuron comparingAmplitudeNormalized_single_spike_binsize',num2str(binsize),'.fig'],'fig');
            saveas(gcf,[conditionfolder{i},'/','neuron comparingAmplitudeNormalized_single_spike_binsize',num2str(binsize),'.tif'],'tif');
            saveas(gcf,[conditionfolder{i},'/','neuron comparingAmplitudeNormalized_single_spike_binsize',num2str(binsize),'.eps'],'epsc');

            save([conditionfolder{i},'/','neuron_comparingAmplitudeS_binsize',num2str(binsize),'data.mat'],'amplitudeSmoothing','sumamplitudeObject','radius','posObjects','countTime');
