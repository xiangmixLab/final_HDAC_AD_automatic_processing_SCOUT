...
function fr2c=to_circle_ratemap(neuron_non_circle,neuron_circle,behav_non_circle,behav_circle)
...
behav_non_cir_pos_trans=pol2cart(theta_ncir,rho_ncir_trans);
