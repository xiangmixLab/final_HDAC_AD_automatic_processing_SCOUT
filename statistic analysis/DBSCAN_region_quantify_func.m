...
function [avg_max_region,avg_max_reg_shuf_all,avg_max_reg_shuf_all_95]=DBSCAN_region_quantify_func(savedir,data1,data2,fig1,fig2,fig3,fig4,foldername,group_record,clust_num,shuffles_num,clust_idx)
