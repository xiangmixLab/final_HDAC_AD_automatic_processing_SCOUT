...
function distance_time_all_analysis(group,cfolder,groupname,nameparts,conditionfolder,num_of_conditions,foldernamet,numpartsall,in_use_objects,exp)
close all;    
...
%             text(max(leng_all_obj)-10,max(max_all_obj)-(idor2-1)*0.1,namedocell{idor2},'color',colorm{idor2});
        ...
        saveas(gcf,[cfolder,'/',groupname{ikkk},'_',nameparts{i},'distancetimeRelationship','.fig'],'fig');
        saveas(gcf,[cfolder,'/',groupname{ikkk},'_',nameparts{i},'distancetimeRelationship','.tif'],'tif');
        saveas(gcf,[cfolder,'/',groupname{ikkk},'_',nameparts{i},'distancetimeRelationship','.eps'],'epsc');
        save([cfolder,'/',groupname{ikkk},'_',nameparts{i},'distancetimeRelationship_data.mat'],'distance_time_relationship_obj_all_m_all_c','dis_ori_all_m_all_c');
        close;
...
%             text(max(leng_all_obj)-10,max(max_all_obj)-(idor2-1)*0.1,namedocell{idor2},'color',colorm{idor2});
        ...
        set(gcf,'renderer','painters');
        saveas(gcf,[cfolder,'/',groupname{ikkk},'_',nameparts{i},'distance_totalTime_Relationship','.fig'],'fig');
        saveas(gcf,[cfolder,'/',groupname{ikkk},'_',nameparts{i},'distance_totalTime_Relationship','.tif'],'tif');
        saveas(gcf,[cfolder,'/',groupname{ikkk},'_',nameparts{i},'distance_totalTime_Relationship','.eps'],'epsc');
        save([cfolder,'/',groupname{ikkk},'_',nameparts{i},'distance_totalTime_Relationship_data.mat'],'distance_time_relationship_obj_all_m_all_c','dis_ori_all_m_all_c');
        close;
