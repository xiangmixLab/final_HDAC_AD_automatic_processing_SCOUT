...
function [A_color,A_color_region,avg_max_region,avg_max_reg_shuf_all,avg_max_reg_shuf_all_95,A_color_region_shuffle]=DBSCAN_region_quantify_func_single_group(group_record,cond_sign,neuronIndividuals_new)
...
[avg_max_region,avg_max_peri,~,~,area_thresh_all]=DBSCAN_region_perimeter_quantify_func({region_all},[d1,d2]);
for k=1:shuffles
