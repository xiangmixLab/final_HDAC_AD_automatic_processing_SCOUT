function [AR,RI,MI,HI,nc]=RandIndex(c1,c2)
...
n=sum(sum(C));
nis=sum(sum(C,2).^2);		%sum of squares of sums of rows, # of elements in c1's clusters
njs=sum(sum(C,1).^2);		%sum of squares of sums of columns, # of elements in c2's clusters
