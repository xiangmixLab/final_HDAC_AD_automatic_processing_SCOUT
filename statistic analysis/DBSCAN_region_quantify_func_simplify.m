...
function [A_color,A_color_region,avg_max_region,avg_max_reg_shuf_all,avg_max_reg_shuf_all_95]=DBSCAN_region_quantify_func_simplify(group_record,clust_num,shuffles_num,clust_idx,cond_sign,neuronIndividuals_new)
