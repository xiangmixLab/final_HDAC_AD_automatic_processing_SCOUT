function [firingRateAll,countAll,countTime] = calculatingCellSpatialForSingleData_adapted_mouob_amp(neuron,behavpos,behavtime,behavROI,binsize,Segment,threshold,temp,moutoob,intensity,plotting,range1,countTimeThresh)
%% Inputs:
