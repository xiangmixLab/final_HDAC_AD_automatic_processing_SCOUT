function [firingRateAll,countAll,countTime] = calculatingCellSpatialForSingleData_adapted_mouob_not_look(neuron,behavpos,behavtime,behavROI,binsize,Segment,threshold,temp,moutoob,intensity,plotting,range1,countTimeThresh)
%% Inputs:
...
%              pcolor(firingRate2);
        ...
        firingRateAll{k} = firingRate.*range1;
        countAll{k} = count.*range1;
        countTime=countTime.*range1;
