function [firingRateAll,countAll,countTime] = calculatingCellSpatialForSingleData(neuron,behav,Segment,threshold,binsize,temp,intensity,plotting)
%% Inputs:
...
if nargin<8;     plotting = false; end
if nargin<7;     intensity = false; end
if nargin<6;     temp = 'S'; end
