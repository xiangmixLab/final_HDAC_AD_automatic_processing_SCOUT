function plottingFiringBehaviorSpatialForSingleData_adapted(neuron,behavpos,behavtime,behavROI,firingRate,segment,threshFiring,threshSpatial,threshSpatial_2,threshSpatial_3,conditionfolder,sectionindex,binsize,tempname,behavcell,place_cells,TinfoPerSecond,countTime,all_condition_max)
...
%         end
    ...
    if mod(kk,numFig) == 0 || kk == max(segment)
        ...
        close all;
        disp(['fin ',strcat(experimentName,'_CellFiringBeaviorSpatial_',num2str(i),'_binsize',num2str(binsize),tempname,'.fig')])
    end   
end
