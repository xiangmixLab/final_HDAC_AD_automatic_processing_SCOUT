function [ outputMaps ] = filter2DMatrices_manual_size( inputMaps, downsampledFlag,manual_size )
...
if ~isempty(manual_size)
    halfNarrow = manual_size(1);
    narrowStdev = manual_size(2);
end
