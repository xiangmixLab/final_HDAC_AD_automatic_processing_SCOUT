...
[filename, filepath] = uigetfile('Select Template');
...
options_r = NoRMCorreSetParms('d1',d1-bound,'d2',d2-bound,'bin_width',50,'max_shift',50,'iter',1,'correct_bidir',false);
