function [fname,num2read,data_shape]=video_registration_main_adapted(use_non_rigid,base_index,projection_type,automatic,projection_dir,data_type)
...
fname=fullfile(path,'final_concatenate_stack.mat');
