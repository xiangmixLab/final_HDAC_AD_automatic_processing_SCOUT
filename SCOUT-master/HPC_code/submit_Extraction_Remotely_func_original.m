function submit_Extraction_Remotely_func_original(extraction_folder)
...
edit_sh_file_adapted([loc_path,'full_pipeline_hpc.sh'],Host_folder,'full_pipeline_hpc_code');
ssh2_conn=scp_put(ssh2_conn,'full_pipeline_hpc.sh',host_path,loc_path);

ssh2_conn=ssh2_command(ssh2_conn,['test -f ',[host_path,'full_pipeline_hpc_code'],' && echo "exists"']);
