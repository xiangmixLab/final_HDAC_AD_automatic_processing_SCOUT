function neuron=run_demo_endoscope(filename,neuron_centers)
%% clear workspace
...
merge_thr = [1e-1, .65, 0];     % thresholds for merging neurons; [spatial overlap ratio, temporal correlation of calcium traces, spike correlation]
dmin = 1;
...
K = 50; % maximum number of neurons to search within each patch. you can use [] to search the number automatically
...
miter = 1; 
    ...
    % neuron.playMovie(Ysignal); % play the video data after subtr
