...
function m = motion_correction_adapted(Fsi, Fsi_new, spatialr, se, ismc, flag,filename)
% main_processing
...
%   Jinghao Lu 06/10/2016
    ...
    if ~exist('filename','var')||isempty(filename)
        ...
        [path,nam,fmt]=fileparts(filename);
        path_name=path;
...
%         filecur = [path_name, file_base{i}, '_data_processed.mat'];
    ...
    if overwrite_flag
        ...
        delete([path_name, file_base{i}, '_frame_all.mat']);
    end
%     end